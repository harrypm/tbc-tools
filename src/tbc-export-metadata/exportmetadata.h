...
public:
    ...
    void updateFieldVitsMetrics(const ExportMetaData::VitsMetrics &vitsMetrics, qint32 sequentialFieldNumber);
    void updateFieldVbi(const ExportMetaData::Vbi &vbi, qint32 sequentialFieldNumber);
    void updateFieldNtsc(const ExportMetaData::Ntsc &ntsc, qint32 sequentialFieldNumber);
    void updateFieldVitc(const ExportMetaData::Vitc &vitc, qint32 sequentialFieldNumber);
    void updateFieldClosedCaption(const ExportMetaData::ClosedCaption &closedCaption, qint32 sequentialFieldNumber);
    void updateFieldDropOuts(const ExportDropOuts &dropOuts, qint32 sequentialFieldNumber);
    ...
    qint32 convertClvTimecodeToFrameNumber(ExportMetaData::ClvTimecode clvTimeCode);
    ExportMetaData::ClvTimecode convertFrameNumberToClvTimecode(qint32 clvFrameNumber);
    ...
    static bool parseVideoSystemName(QString name, ExportMetaData::VideoSystem &system);
