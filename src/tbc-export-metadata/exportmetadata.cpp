...
static const VideoSystemDefaults &getSystemDefaults(const ExportMetaData::VideoParameters &videoParameters)
{
...
bool ExportMetaData::parseVideoSystemName(QString name, ExportMetaData::VideoSystem &system)
{
...
// Read Vbi from JSON
void ExportMetaData::Vbi::read(JsonReader &reader)
{
    reader.beginObject();
...
// Write Vbi to JSON
void ExportMetaData::Vbi::write(JsonWriter &writer) const
{
    assert(inUse);
...
void ExportMetaData::VideoParameters::read(JsonReader &reader)
{
...
void ExportMetaData::VideoParameters::write(JsonWriter &writer) const
{
    assert(isValid);
    ...
    // only write bool member is true, because default is false
...
void ExportMetaData::VitsMetrics::read(JsonReader &reader)
{
    reader.beginObject();
...
void ExportMetaData::VitsMetrics::write(JsonWriter &writer) const
{
    assert(inUse);
    ...
    // Keep members in alphabetical order
    // we assume that with a value of 0.0 those values were not set
    if (bPSNR != 0.0) writer.writeMember("bPSNR", bPSNR);
    if (wSNR != 0.0) writer.writeMember("wSNR", wSNR);

    writer.endObject();
}

// Read Ntsc from JSON
void ExportMetaData::Ntsc::read(JsonReader &reader, ClosedCaption &closedCaption)
{
    reader.beginObject();
...
// Write Ntsc to JSON
void ExportMetaData::Ntsc::write(JsonWriter &writer) const
{
    assert(inUse);
...
// Read Vitc from JSON
void ExportMetaData::Vitc::read(JsonReader &reader)
{
    reader.beginObject();
...
// Write Vitc to JSON
void ExportMetaData::Vitc::write(JsonWriter &writer) const
{
    assert(inUse);
...
void ExportMetaData::ClosedCaption::read(JsonReader &reader)
{
    reader.beginObject();
...
void ExportMetaData::ClosedCaption::write(JsonWriter &writer) const
{
    assert(inUse);
...
void ExportMetaData::PcmAudioParameters::read(JsonReader &reader)
{
    reader.beginObject();
...
void ExportMetaData::PcmAudioParameters::write(JsonWriter &writer) const
{
    assert(isValid);
...
void ExportMetaData::Field::read(JsonReader &reader)
{
    reader.beginObject();
...
// Write Field to JSON
void ExportMetaData::Field::write(JsonWriter &writer) const
{
    writer.beginObject();
    ...
    // medianBurstIRE of 0.0 is probably not set, don't write it
    if (medianBurstIRE != 0.0) {
    ...
    // only write optional bool if set
    if (pad) writer.writeMember("pad", pad);
...
bool ExportMetaData::read(QString fileName)
{
...
bool ExportMetaData::write(QString fileName) const
{
    ...
    writer.writeMember("exportMetadata");
    writer.beginObject();
    writer.writeMember("majorVersion", 1);
    writer.writeMember("minorVersion", 0);
    writer.endObject();
    // Keep members in the order of ld/vhs-decode
...
void ExportMetaData::readFields(JsonReader &reader)
{
    reader.beginArray();
...
void ExportMetaData::writeFields(JsonWriter &writer) const
{
    writer.beginArray();
...
const ExportMetaData::VideoParameters &ExportMetaData::getVideoParameters()
{
...
void ExportMetaData::setVideoParameters(const ExportMetaData::VideoParameters &_videoParameters)
{
...
const ExportMetaData::PcmAudioParameters &ExportMetaData::getPcmAudioParameters()
{
...
void ExportMetaData::setPcmAudioParameters(const ExportMetaData::PcmAudioParameters &_pcmAudioParameters)
{
...
void ExportMetaData::initialiseVideoSystemParameters()
{
...
void ExportMetaData::processLineParameters(ExportMetaData::LineParameters &lineParameters)
{
    lineParameters.applyTo(videoParameters);
}

// Validate and apply to a set of VideoParameters
void ExportMetaData::LineParameters::applyTo(ExportMetaData::VideoParameters &videoParameters)
{
...
const ExportMetaData::Field &ExportMetaData::getField(qint32 sequentialFieldNumber)
{
    qint32 fieldNumber = sequentialFieldNumber - 1;
    if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
        qCritical() << "ExportMetaData::getField(): Requested field number" << sequentialFieldNumber << "out of bounds!";
    }
...
const ExportMetaData::VitsMetrics &ExportMetaData::getFieldVitsMetrics(qint32 sequentialFieldNumber)
{
    qint32 fieldNumber = sequentialFieldNumber - 1;
    if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
        qCritical() << "ExportMetaData::getFieldVitsMetrics(): Requested field number" << sequentialFieldNumber << "out of bounds!";
    }
...
const ExportMetaData::Vbi &ExportMetaData::getFieldVbi(qint32 sequentialFieldNumber)
{
    qint32 fieldNumber = sequentialFieldNumber - 1;
    if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
        qCritical() << "ExportMetaData::getFieldVbi(): Requested field number" << sequentialFieldNumber << "out of bounds!";
    }
...
const ExportMetaData::Ntsc &ExportMetaData::getFieldNtsc(qint32 sequentialFieldNumber)
{
    qint32 fieldNumber = sequentialFieldNumber - 1;
    if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
        qCritical() << "ExportMetaData::getFieldNtsc(): Requested field number" << sequentialFieldNumber << "out of bounds!";
    }
...
const ExportMetaData::Vitc &ExportMetaData::getFieldVitc(qint32 sequentialFieldNumber)
{
    qint32 fieldNumber = sequentialFieldNumber - 1;
    if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
        qCritical() << "ExportMetaData::getFieldVitc(): Requested field number" << sequentialFieldNumber << "out of bounds!";
    }
...
const ExportMetaData::ClosedCaption &ExportMetaData::getFieldClosedCaption(qint32 sequentialFieldNumber)
{
    qint32 fieldNumber = sequentialFieldNumber - 1;
    if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
        qCritical() << "ExportMetaData::getFieldClosedCaption(): Requested field number" << sequentialFieldNumber << "out of bounds!";
    }
...
const ExportDropOuts &ExportMetaData::getFieldDropOuts(qint32 sequentialFieldNumber)
{
    qint32 fieldNumber = sequentialFieldNumber - 1;
    if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
        qCritical() << "ExportMetaData::getFieldDropOuts(): Requested field number" << sequentialFieldNumber << "out of bounds!";
    }
...
void ExportMetaData::updateField(const ExportMetaData::Field &field, qint32 sequentialFieldNumber)
{
    qint32 fieldNumber = sequentialFieldNumber - 1;
    if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
        qCritical() << "ExportMetaData::updateFieldVitsMetrics(): Requested field number" << sequentialFieldNumber << "out of bounds!";
    }
...
void ExportMetaData::updateFieldVitsMetrics(const ExportMetaData::VitsMetrics &vitsMetrics, qint32 sequentialFieldNumber)
{
    qint32 fieldNumber = sequentialFieldNumber - 1;
    if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
        qCritical() << "ExportMetaData::updateFieldVitsMetrics(): Requested field number" << sequentialFieldNumber << "out of bounds!";
...
// This method sets the field VBI metadata for a field
void ExportMetaData::updateFieldVbi(const ExportMetaData::Vbi &vbi, qint32 sequentialFieldNumber)
{
    qint32 fieldNumber = sequentialFieldNumber - 1;
    if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
        qCritical() << "ExportMetaData::updateFieldVbi(): Requested field number" << sequentialFieldNumber << "out of bounds!";
    }
...
void ExportMetaData::updateFieldNtsc(const ExportMetaData::Ntsc &ntsc, qint32 sequentialFieldNumber)
{
    qint32 fieldNumber = sequentialFieldNumber - 1;
    if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
        qCritical() << "ExportMetaData::updateFieldNtsc(): Requested field number" << sequentialFieldNumber << "out of bounds!";
    }
...
void ExportMetaData::updateFieldVitc(const ExportMetaData::Vitc &vitc, qint32 sequentialFieldNumber)
{
    qint32 fieldNumber = sequentialFieldNumber - 1;
    if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
        qCritical() << "ExportMetaData::updateFieldVitc(): Requested field number" << sequentialFieldNumber << "out of bounds!";
    }
...
void ExportMetaData::updateFieldClosedCaption(const ExportMetaData::ClosedCaption &closedCaption, qint32 sequentialFieldNumber)
{
    qint32 fieldNumber = sequentialFieldNumber - 1;
    if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
        qCritical() << "ExportMetaData::updateFieldClosedCaption(): Requested field number" << sequentialFieldNumber << "out of bounds!";
    }
...
void ExportMetaData::updateFieldDropOuts(const ExportDropOuts &dropOuts, qint32 sequentialFieldNumber)
{
    qint32 fieldNumber = sequentialFieldNumber - 1;
    if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
        qCritical() << "ExportMetaData::updateFieldDropOuts(): Requested field number" << sequentialFieldNumber << "out of bounds!";
    }
...
void ExportMetaData::clearFieldDropOuts(qint32 sequentialFieldNumber)
{
    qint32 fieldNumber = sequentialFieldNumber - 1;
    if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
        qCritical() << "ExportMetaData::clearFieldDropOuts(): Requested field number" << sequentialFieldNumber << "out of bounds!";
    }
...
void ExportMetaData::appendField(const ExportMetaData::Field &field)
{
    fields.append(field);
...
qint32 ExportMetaData::getNumberOfFields()
{
    return fields.size();
}
...
void ExportMetaData::setNumberOfFields(qint32 numberOfFields)
{
...
qint32 ExportMetaData::getNumberOfFrames()
{
...
qint32 ExportMetaData::getFieldNumber(qint32 frameNumber, qint32 field)
{
    ...
    if (firstFieldNumber > getNumberOfFields()) {
        qCritical() << "ExportMetaData::getFieldNumber(): First field number exceed the available number of fields!";
        firstFieldNumber = -1;
        secondFieldNumber = -1;
    }
    ...
    if (secondFieldNumber > getNumberOfFields()) {
        qCritical() << "ExportMetaData::getFieldNumber(): Second field number exceed the available number of fields!";
        firstFieldNumber = -1;
        secondFieldNumber = -1;
    }
    ...
    if (getField(secondFieldNumber).isFirstField) {
        qCritical() << "ExportMetaData::getFieldNumber(): Both of the determined fields have isFirstField set - the TBC source video is probably broken...";
    }
...
qint32 ExportMetaData::convertClvTimecodeToFrameNumber(ExportMetaData::ClvTimecode clvTimeCode)
{
...
ExportMetaData::ClvTimecode ExportMetaData::convertFrameNumberToClvTimecode(qint32 frameNumber)
{
...
QString ExportMetaData::getVideoSystemDescription() const
{
...
void ExportMetaData::generatePcmAudioMap()
{
    pcmAudioFieldStartSampleMap.clear();
    pcmAudioFieldLengthMap.clear();

    qDebug() << "ExportMetaData::generatePcmAudioMap(): Generating PCM audio map...";
...
qint32 ExportMetaData::getFieldPcmAudioStart(qint32 sequentialFieldNumber)
{
...
qint32 ExportMetaData::getFieldPcmAudioLength(qint32 sequentialFieldNumber)
{
