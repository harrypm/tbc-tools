...
class TestWrappersChromaDecoder:
    ...
    test_cases = [
        ...
        WrapperTestCase(
            id="pal secam decoder (exception - separation)",
            input_tbc=f"{get_path('pal_svideo')}.tbc",
        ...
        WrapperTestCase(
            id="pal secam-predemod decoder (exception - separation)",
            input_tbc=f"{get_path('pal_svideo')}.tbc",
            input_opts=["--chroma-decoder", "secam-predemod"],
            expected_opts=[],
            expected_exc=pytest.raises(exceptions.InvalidChromaDecoderError),
        ),
        WrapperTestCase(
        ...
        WrapperTestCase(
            id="secam composite secam-predemod decoder opts",
            input_tbc=f"{get_path('pal_composite')}.tbc",
            input_opts=[
                "--input-tbc-json",
                str(get_path("secam_composite.tbc.json")),
        ...
        WrapperTestCase(
            id="secam composite secam-predemod with first-line-is-red override",
            input_tbc=f"{get_path('pal_composite')}.tbc",
            input_opts=[
                "--input-tbc-json",
                str(get_path("secam_composite.tbc.json")),
        ...
        WrapperTestCase(
            id="secam composite pal decoder (exception - separation)",
            input_tbc=f"{get_path('pal_composite')}.tbc",
            input_opts=[
                "--input-tbc-json",
                str(get_path("secam_composite.tbc.json")),
